...
iOSのビルドには Mac と Xcode が要るため、まだ着手していません。
Mac側で作業する人向けの手順を [app/ios引き継ぎ手順.md](app/ios引き継ぎ手順.md) にまとめてあります。
アイコンとApp Store用のスクリーンショットは [ストア掲載用/iOS/](ストア掲載用/iOS/) に用意済みです。
